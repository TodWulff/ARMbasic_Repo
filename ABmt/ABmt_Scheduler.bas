...
// This is so that the scheduler's entry point is known
ABmt_Task_0:
	goto main
...
'	ABmt_ResetTimer
	print "Index'g Tasks: "; _ABmt_TaskCount," T: ";timer
	...
	print "Tasks Indexed: "; ABmt_TaskCount," T: ";timer

endsub

main:		' ABmt_Task_0
	print _uinput("Paused - press enter to continue> ")
	ABmt_ResetTimer
...
main1:
	...
	i = addressof ABmt_TaskRestart
	print "Restarting Tasks @: 0x";i2h(i)," T: ";timer
