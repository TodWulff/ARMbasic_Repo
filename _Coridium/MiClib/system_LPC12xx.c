...
#define SYSPLLCLKSEL_Val      0x00000000  // use iRC 0x00000001
#define SYSPLL_SETUP          0
#define SYSPLL_MSEL           14		// mulltiplier value -1
#define SYSPLL_PSEL           1			// divider value (1 << (psel+1))
#define SYSPLLCTRL_Val        ((SYSPLL_PSEL << 5) | SYSPLL_MSEL)
...
#define __DIVSEL   (((WDTOSCCTRL_Val & 0x1F) << 1) + 2)
    ...
    /* sys_pllclkin calculation */
     ...
     #if (CHECK_RANGE(__SYS_PLLCLKIN * (SYSPLL_MSEL + 1), 100000000, 320000000))
      #error "PLL: frequency out of range!"
     #endif
      #define  __SYS_PLLCLKOUT         (__SYS_PLLCLKIN * (SYSPLL_MSEL + 1) / (2 * (1 << SYSPLL_PSEL)))
     #if (CHECK_RANGE(__SYS_PLLCLKOUT, 0, 45000000))
      #error "Main CLK: frequency out of range!"
     #endif
    #else
