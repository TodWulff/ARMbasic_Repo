 ...
 */
unsigned int Chip_POWER_SetPLL(unsigned int multiply_by, unsigned int input_freq);
 ...
 * @return	nothing
 */
void Chip_POWER_SetFLASHPower(unsigned int new_power_mode);
 ...
 */
unsigned int Chip_POWER_SetVoltage(PERF_MODE_T mode, unsigned int desired_freq);
 ...
 * @return	Nothing
 */
unsigned int Chip_POWER_SetVDLevel(POWER_DOMAIN_T domain, POWER_VOLTAGELEVEL_T level, POWER_FINEVOLTAGELEVEL_T flevel);
 ...
 */
void Chip_POWER_EnterPowerMode(POWER_MODE_T mode, unsigned int peripheral_ctrl);
 ...
 */
void Chip_POWER_EnterPowerModeReloc(POWER_MODE_T mode, unsigned int peripheral_ctrl, unsigned int relMem);
 ...
 * @return	Nothing
 */
void Chip_POWER_RelocAPI(unsigned int *relMem, unsigned int size);
 ...
 */
void Chip_POWER_EnterPowerModeIramOnly(unsigned int peripheral_ctrl);
 ...
 */
unsigned int Chip_POWER_GetROMVersion(void);
