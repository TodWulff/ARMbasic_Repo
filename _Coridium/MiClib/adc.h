...
/* max ADC clock feq. */
	...
	#define ADC_CLOCKRATE_MAX	13000000	
//	#define ADC_CLOCKRATE_MAX	 9000000	
#elif defined LPC4330 || defined LPC4337 || defined LPC1850			
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined STM32F411 // I'm not sure if NUCLEO even needs to include adc.h, its done in system_xxx
	#define ADC_CLOCKRATE_MAX	12400000	
#elif defined LPC4074 || defined LPC4078			
	#define ADC_CLOCKRATE_MAX	12400000	
#elif defined LPC178x			
	#define ADC_CLOCKRATE_MAX	12400000	
#elif defined LPC15xx			
	#define ADC_CLOCKRATE_MAX	12000000	
#elif defined LPC12xx			
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined LPC1114
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined LPC11U37 || defined LPC11U35 || (defined LPC11U67) || (defined LPC11U68)
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined LPC21xx
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined LPC412x
  #warning need ADC code for 412x
	#define ADC_CLOCKRATE_MAX	 4500000	
#elif defined LPC824
    #define ADC_CLOCKRATE_MAX	 30000000	
#elif defined LPC54102 || defined LPC54618
	#define ADC_CLOCKRATE_MAX	 48000000	
#else
