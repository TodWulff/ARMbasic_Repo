...
typedef struct {                            /*!< (@ 0x40046000) RTC Structure          */
  ...
  __IO uint32_t HOUR;                       /*!< (@ 0x40046028) Hours Register         */
...
typedef struct {                            /*!< (@ 0x40050000) CGU Structure          */
  ...
  __IO uint32_t BASE_USART0_CLK;             /*!< (@ 0x4005009C) Output stage control register  */
  __IO uint32_t BASE_USART1_CLK;             /*!< (@ 0x400500A0) Output stage control register  */
  __IO uint32_t BASE_USART2_CLK;             /*!< (@ 0x400500A4) Output stage control register  */
  __IO uint32_t BASE_USART3_CLK;             /*!< (@ 0x400500A8) Output stage control register  */
...
//  __I  uint32_t RESERVED4[4];
  ...
  __IO uint32_t CLK_M4_USART1_CFG;           /*!< (@ 0x40051510) CLK_M4_UART1 clock configuration register */
  __I  uint32_t CLK_M4_USART1_STAT;          /*!< (@ 0x40051514) CLK_M4_UART1 clock status register */
...
#define LPC_UART_TypeDef LPC_USARTn_Type		// for BASIC
...
#define LPC_UART0_BASE			LPC_USART0_BASE           
#define LPC_UART1_BASE			LPC_USART1_BASE           
#define LPC_UART2_BASE			LPC_USART2_BASE           
#define LPC_UART3_BASE			LPC_USART3_BASE           
...
#define LPC_UART1                 ((LPC_UART1_Type          *) LPC_UART1_BASE)		// for BASIC
#define LPC_UART2                 ((LPC_USARTn_Type         *) LPC_UART2_BASE)		// for BASIC
#define LPC_UART3                 ((LPC_USARTn_Type         *) LPC_UART3_BASE)		// for BASIC
...
// SPIFI Flash space for code and where it gets copied to and executed

// Flash locations
	
#define	IOH_FIRMWARE	0x14030000		// for easy mapping locate these on 0x10000 boundaries -- wasteful, but 3/4 of 8M SPIFI still free (<<50 cents)
#define	M0_FIRMWARE		0x14020000	
#define	M4_FIRMWARE		0x14000000	

// RAM targets for code

#define M4_CODE_RAM		0x10000000
#define M4_USER_CODE	0x10008000

#define M0_CODE_RAM		0x10080000
#define M0_USER_CODE	0x10084000		// user BASIC program starts here

#define IOH_CODE_RAM	0x2000C000
