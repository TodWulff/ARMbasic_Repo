 ...
 */
//MAR __STATIC_INLINE bool Chip_CPU_IsM4Core(void) {
//MAR 	/* M4 core is designated by values 0xC24 on bits 15..4 */
//MAR 	if (((SCB->CPUID >> 4) & 0xFFF) == 0xC24) {
//MAR 		return true;
//MAR 	}
 ...
 */
unsigned char Chip_CPU_IsMasterCore(void);
 ...
 * reset M0+ core.
 */
void Chip_CPU_CM0Boot(unsigned int *coentry, unsigned int *costackptr);
 ...
 * reset M0+ core.
 */
void Chip_CPU_CM4Boot(unsigned int *coentry, unsigned int *costackptr);
...
//unsigned int coentry = 0x4000	// 2nd half of sector 0 for M0 Flash
//unsigned int costackptr = 0x03401FE0; // top of stack?
//Chip_CPU_CM4Boot(coentry, costackptr);
