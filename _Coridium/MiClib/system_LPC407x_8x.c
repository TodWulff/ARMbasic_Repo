...
#define CLOCK_SETUP           1
 ...
 #define SCS_Val               0x00000020	// enable crystal osc
 #define CLKSRCSEL_Val         0x00000001	// 
#else
 #define SCS_Val               0x00000000
 #define CLKSRCSEL_Val         0x00000000	// use IRC = 0
#endif 
#define PLL0_SETUP            1
#define PLL0CFG_Val           0x00000009 // does this give 120 MHz?
#define PLL1_SETUP            0 //1          // this should be 0. mar
#define PLL1CFG_Val           0x00000023
#define CCLKSEL_Val           0x00000101
#define USBCLKSEL_Val         0x00000201 // s/b 0
#define EMCCLKSEL_Val         0x00000001
#define PCLKSEL_Val           4 //0x00000002 // this should be 4 for 1/4
#define SPIFICLKSEL_Val       0x00000202
#define PCONP_Val             0x03C0825E // turn off i2c, spi, ssp, let ADinit turn on A/D 0x042887DE
#define CLKOUTCFG_Val         0 //0x00000100 // this should be 101 or 102. mar
...
#ifdef USE_RTC_XTAL
	LPC_SC->PCONP   |= 0x200;			// make sure RTC powered on
	LPC_RTC->CCR	= 0x11;				// and turn on RTC, disable calibration -- BASIC program need to enable that if desired
#endif	

// do this here or create setup_40xx.c? 
	//copy vector table to RAM
	MEMCPY((void *)0x10000000, (void *)0x00000000, 58<<2);
...
void IO2AD(int chan) {
	if (chan == 2) 		LPC_IOCON->P0_25 = 0x00000001;	// convert AD2 from P0.25
	else if (chan == 3)	LPC_IOCON->P0_26 = 0x00000001;	// convert AD3 from P0.26
   #ifdef LPC4078
	else if (chan == 0)	LPC_IOCON->P0_23 = 0x00000001;	// convert AD0 from P0.23
	else if (chan == 1)	LPC_IOCON->P0_24 = 0x00000001;	// convert AD1 from P0.24
	else if (chan == 6)	LPC_IOCON->P0_12 = 0x00000003;	// convert AD5 from P0.12
	else if (chan == 7)	LPC_IOCON->P0_13 = 0x00000003;	// convert AD5 from P0.13
   #endif	
	else if (chan == 4) LPC_IOCON->P1_30 = 0x00000003;	// convert AD4 from P1.30
	else if (chan == 5)	LPC_IOCON->P1_31 = 0x00000003;	// convert AD5 from P1.31
}
