...
//   </e>
//
//   <h> CPU Clock Configuration Register (CCLKSEL)
//     <o7.0..7>  CCLKSEL: Divide Value for CPU Clock from PLL0
//                     <3-256><#-1>
//   </h>
//
//   <h> USB Clock Configuration Register (USBSEL)
...
#define CLKSRCSEL_Val         0x00000000	// 0 - IRC,  1 - Xtal
#define PLL0_SETUP            1
#define PLL0CFG_Val           0x00000007	// PLL0 - 12 MHz x8 /1 /2
#define PLL1_SETUP            0
#define PLL1CFG_Val           0x00000023
#define CCLKSEL_Val           0x00000001	// dont enable it 0x100 bit until the PLL is locked
...
#if ((CCLKSEL_Val != 0) && (CCLKSEL_Val & ~0x11F))
   #error "CCLKSEL: CCLKSEL field out of range"
#endif

#if (CHECK_RSVD((USBSEL_Val), ~0x0000000F))
   #error "USBSEL: Invalid values of reserved bits!"
#endif
 ...
 *----------------------------------------------------------------------------*/
int  SystemCoreClock = IRC_OSC; /*!< System Clock Frequency (Core Clock)  */
int  PeripheralFrequency = IRC_OSC;
