...
#if defined ARMweb || defined UART_NOBUFFER
#else
 #define TX_USE_BUFFER
#endif
...
#ifdef MIN_UART			// keep the definitions consistent -- unlike NXP
  #define RBR RXDATA
  #define THR TXDATA
  #define LSR STAT
#endif
...
#ifdef LPC1768
  #define UART_RX_BUFFER_SIZE	1024		// must be powers of 2
#else
...
#else 
 #define UART_TX_BUFFER_SIZE	4	// 0 fails in Keil
...
//NOT YET void RTC_ISR(void);
//TEST    void eint0ISR(void);
...
externC void NmiSR(void);      
externC void FaultISR(void);
externC void FaultMPU(void);
externC void FaultBUS(void);
externC void FaultUSE(void);
externC void IntDefaultHandler(void);
