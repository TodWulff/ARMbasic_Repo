...
#ifndef __SYSTEM_LPC11U6Uxx_H
#define __SYSTEM_LPC11U6Uxx_H
...
#if defined LPC11U67
  #define CPU_NUM			0x1167
  #define MAX_VAR_COUNT   	(1024+256)//GET THIS
  #define BASIC_CODE_START	0x08000>>4
  #define FLASH_END			0x20000>>4//11U67
#elif defined LPC11U68
  #define CPU_NUM			0x1168
  #define MAX_VAR_COUNT   	(6*1024) // still almost 1K free
  #define BASIC_CODE_START	0x08000>>4
  #define FLASH_END			0x40000>>4//11U68
#endif

#define USE_AD	

#define FLASHMAP_11U68
