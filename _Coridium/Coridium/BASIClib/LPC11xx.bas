...
#define WU0_0_IRQn  	0	' Wakeup PIO0.0 
#define WU0_1_IRQn  	1	' Wakeup PIO0.1 
#define WU0_2_IRQn  	2	' Wakeup PIO0.2 
#define WU0_3_IRQn  	3	' Wakeup PIO0.3 
#define WU0_4_IRQn  	4	' Wakeup PIO0.4 
#define WU0_5_IRQn  	5	' Wakeup PIO0.5 
#define WU0_6_IRQn  	6	' Wakeup PIO0.6 
#define WU0_7_IRQn  	7	' Wakeup PIO0.7 
#define WU0_8_IRQn  	8	' Wakeup PIO0.8 
#define WU0_9_IRQn  	9	' Wakeup PIO0.9 
#define WU0_10_IRQn  	10 	' Wakeup PIO0.10
#define WU0_11_IRQn  	11 	' Wakeup PIO0.11
#define WU1_0_IRQn  	12 	' Wakeup PIO1.0 
#define CAN_IRQn 		13 	' CAN           
#define SSP1_IRQn 		14 	' SSP1          
#define I2C_IRQn 		15 	' I2C           
#define TIMER2_IRQn 	16 	' Timer0 NOTE: swapped Timers 0-1 with 2-3
#define TIMER3_IRQn		17 	' Timer1        
#define TIMER0_IRQn 	18 	' Timer2        
#define TIMER1_IRQn 	19 	' Timer3        
#define SSP0_IRQn 		20 	' SSP0           
#define UART0_IRQn 		21 	' UART0         
' 38: : Reserved        22 	'
' 39: : Reserved        23 	'
#define USB_IRQn 		24 	' ADC           
#define ADC_IRQn  		25 	' Watchdog Timer
#define BOD_IRQn 		26 	' BrownOut      
' 43: : Reserved        27 	'
#define GPIO3_IRQn 		28 	' GPIO3         
#define GPIO2_IRQn 		29 	' GPIO2         
#define GPIO1_IRQn 		30 	' GPIO1         
#define GPIO0_IRQn 		31	' GPIO0         
' 48: : Reserved
...
#define VICIntSetPend0	VICIntSetPend		' most other Cortex parts have multiple NVIC Set Pending registers -- used in multitasking
