...
#else
 #error this CPU not supported with MultiTask via MRT use at this time
#endif
...
#ifdef LPC824
	#define t1_Blinky_led_port	17
	#define t2_Blinky_led_port	16
	#define t3_Blinky_led_port	15
#elif defined LPC54102
...
sub Init_Tasks
	...
	taskTIME(0) = 174		' arbitrary time in msec for each task
	taskTIME(1) = 174
	taskTIME(2) = 174
	taskTIME(3) = 174
